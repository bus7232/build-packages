...
proot-distro login ubuntu <<-EOF
  ...
  wget https://github.com/godotengine/godot-builds/releases/download/4.3-rc3/Godot_v4.3-rc3_linux.arm32.zip

  unzip Godot_v4.3-rc3_linux.arm32.zip
  chmod +x Godot_v4.3-rc3_linux.arm32.zip
  rm -rf Godot_v4.3-rc3_linux.arm32.zip
